...
export default function UserNoAccess({ showPopup }){
    const {user}=useAuth()
    ...
    const setAction=(upload,isShow)=>{
        ...
        setIsShow(isShow)
         ...
         const filterEmployees=async ()=>{
            ...
            const result=await api.get(`/api/employee/no-access`)
    ...
    return (
        ...
        <div className="employee-page" id="gotoheader">
            <div className="employee-functions">
                <h2>Quản lý nhân sự - Không chức vụ</h2>
